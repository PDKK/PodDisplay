...
void createCylinder(struct obj_t * result) {
    ...
    for (slice=0;slice < num_slices; slice++) {
        ...
        vertices[slice].t1.v2.x = r*sin(2*3.14*slice/num_slices);
        vertices[slice].t1.v2.y = r*cos(2*3.14*slice/num_slices);
        vertices[slice].t1.v2.z = h;
        vertices[slice].t1.v3.x = r*sin(2*3.14*(slice+1)/num_slices);
        vertices[slice].t1.v3.y = r*cos(2*3.14*(slice+1)/num_slices);
        ...
        normals[slice].t1.v2.x = sin(2*3.14*slice/num_slices);
        normals[slice].t1.v2.y = cos(2*3.14*slice/num_slices);
        normals[slice].t1.v2.z = h;
        normals[slice].t1.v3.x = sin(2*3.14*(slice+1)/num_slices);
        normals[slice].t1.v3.y = cos(2*3.14*(slice+1)/num_slices);
        ...
        texCoords[slice].t2.v2.v = 1;
        texCoords[slice].t2.v3.u = (float)(slice+1)/num_slices;
        texCoords[slice].t2.v3.v = 0;
        // normal
    }
